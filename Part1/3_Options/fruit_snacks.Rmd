...
# install assertthat from CRAN if necessary
...
```{r perm_test_sd_prop}
file <- "cache/permsdprop.rds"
if(file.exists(file)) {
    permsdprop <- readRDS(file)
} else {
    n.perm <- 10000
