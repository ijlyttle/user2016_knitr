...
m = m %>% setView(-122.1774315, 37.4264095, zoom = 13)
# popup
m %>% addPopups(-122.1774315, 37.4264095, 'Here is the <b>Stanford University</b>')
rand_lng = function(n = 10) rnorm(n, -122.1774315, .01)
rand_lat = function(n = 10) rnorm(n, 37.4264095, .01)
